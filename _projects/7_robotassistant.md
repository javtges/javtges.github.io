...
description: Computer Vision, ROS, Python, MoveIt, OpenCV
img: assets/img/projects/desk/title.png
importance: 7
category: work
...
{% include video.liquid path="https://www.youtube.com/embed/q6vao0UIHJs" class="img-fluid rounded z-depth-1" %}<br><br>
...
{% include video.liquid path="https://www.youtube.com/embed/mk7GI1-TJjs" class="img-fluid rounded z-depth-1" %}<br><br>
