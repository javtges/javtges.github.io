...
description: Deep Learning, Computer Vision, Python, Pytorch, Tensorflow
img: assets/img/projects/gesture/fist_gesture.png
importance: 5
category: work
related_publications: false
---

{% include video.liquid path="https://www.youtube.com/embed/BBnZKu9_Neg" class="img-fluid rounded z-depth-1" %}
...
![Tensorboard results for experiments on the nvGesture dataset](/assets/img/projects/gesture/tensorboard.png)
<div class="caption">Tensorboard results for experiments on the nvGesture dataset</div>
...
![An infrared image from the dataset](/assets/img/projects/gesture/fist_gesture.png)
<div class="caption">An infrared image from the dataset</div>
...
<p>
This has to do with the input datatype, where the hands in the dataset are clearly segmented opposed to more loosely segmented hands in the live video. This is improved by removing pixels with depth values greater than a threshold of 0.5m, though can still stand to be improved.
</p> <br>
<p>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/gesture/fist_gesture.png" title="Depth and color fist gesture" alt="Depth and color fist gesture" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/gesture/dataset_image.png" title="Infrared image from a dataset" alt="Infrared image from a dataset" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/gesture/drone.png" title="Drone used for gesture control" alt="Drone used for gesture control" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
